function Hero() {
  return (
    <section id="#home" className="text-white h-screen">
      <div className="flex flex-col items-center justify-center w-full h-5/6 px-10 md:px-40 xl:px-96">
        <h1 className="text-white font-bold text-[4rem]">
          Hi, I&apos;m Daniel
        </h1>
        <h3 className="text-center font-semibold text-4xl hero-text-clip">
